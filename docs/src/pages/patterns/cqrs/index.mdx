...
<AnchorLinks>
 ...
 <AnchorLink>The consistency challenge</AnchorLink>
</AnchorLinks>
...
The [shipment order microservice](https://ibm-cloud-architecture.github.io/refarch-kc-order-ms) is implementing this pattern and we are explaining a development approach in [this article](./details/).
...
As a next level we want to address how to [develop a service using CQRS](./details/).
